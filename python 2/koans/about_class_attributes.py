...
class AboutClassAttributes(Koan):
    ...
    def test_classes_have_methods(self):
        # NOTE: Add three new method in Dog
        self.assertEqual(len(dir(object)) + 3, len(dir(self.Dog)))
    ...
    def test_defining_functions_on_individual_objects(self):
        fido = self.Dog()
        # TODO: Need to know more about lambda
    ...
    def test_classes_and_instances_do_not_share_instance_attributes(self):
        ...
        fido.set_name("Rover")
        # NOTE: They don't share the same variable
