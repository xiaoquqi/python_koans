...
class AboutIteration(Koan):
    ...
    def test_iterators_are_a_type(self):
        # NOTE: in ruby, if I defined 1..6, that will include 6
        it = iter(range(1, 6))
    ...
    def test_map_transforms_elements_of_a_list(self):
        ...
        # NOTE: in ruby, seq.collect{ |i| i + 10 }
    ...
    def test_reduce_will_blow_your_mind(self):
        # NOTE: reduce(function, iterable[, initializer])
        ...
        # Use previous return value as next running input
    ...
    def test_use_pass_for_iterations_with_no_body(self):
        # NOTE: iteration from 1 to 4, not include 5
